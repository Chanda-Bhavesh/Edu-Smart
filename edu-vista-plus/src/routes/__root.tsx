...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A friendly all-in-one campus platform for students, faculty, and administration." },
      { name: "author", content: "Campus OS" },
      { property: "og:title", content: "Campus OS — Smart Campus Management" },
      { property: "og:description", content: "Attendance, assignments, fees, certificates and analytics — one warm campus platform." },
